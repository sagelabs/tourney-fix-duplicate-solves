...
from Tourney.models import Challenges, Flags, Hints, Solves, Tags, Tracking, Users
from Tourney.utils import set_config
...
def test_api_challenge_solves_returns_correct_data():
    ...
    app = create_tourney(application_root="/ctf")
    with app.app_context():
        register_user(app)
        client = login_as_user(app)
        chal = gen_challenge(app.db)
