...
from Tourney.cache import cache, clear_team_session, clear_user_session
from Tourney.exceptions.email import (
    UserConfirmTokenInvalidException,
    UserResetPasswordTokenInvalidException,
)
from Tourney.models import Brackets, Teams, UserFieldEntries, UserFields, Users, db
from Tourney.utils import config, email, get_app_config, get_config
from Tourney.utils import user as current_user
from Tourney.utils import validators
from Tourney.utils.config import can_send_mail, is_teams_mode
from Tourney.utils.config.integrations import mlc_registration
from Tourney.utils.config.visibility import registration_visible
from Tourney.utils.crypto import verify_password
from Tourney.utils.decorators import ratelimit
from Tourney.utils.decorators.visibility import check_registration_visibility
from Tourney.utils.helpers import error_for, get_errors, markup
from Tourney.utils.logging import log
from Tourney.utils.modes import TEAMS_MODE
from Tourney.utils.security.auth import generate_preset_admin, login_user, logout_user
...
from Tourney.utils.validators import ValidationError
...
def reset_password(data=None):
    if config.can_send_mail() is False and data is None:
        return render_template(
            ...
            errors=[
                markup(
                    "This instance is not configured to send email.<br> Please contact an organizer to have your password reset."
                )
            ],
        )
