...
from Tourney.cache import clear_user_recent_ips
from Tourney.exceptions import UserNotFoundException, UserTokenExpiredException
from Tourney.exceptions.email import UserResetPasswordTokenInvalidException
from Tourney.models import Tracking, db
from Tourney.utils import config, get_app_config, get_config, import_in_progress, markdown
from Tourney.utils.config import (
    can_send_mail,
    ctf_logo,
    ctf_name,
    ctf_theme,
...
from Tourney.utils.config.pages import get_pages
from Tourney.utils.dates import isoformat, unix_time, unix_time_millis, unix_time_to_utc
from Tourney.utils.events import EventManager, RedisEventManager
from Tourney.utils.humanize.words import pluralize
from Tourney.utils.modes import generate_account_url, get_mode_as_word
from Tourney.utils.plugins import (
...
from Tourney.utils.security.auth import login_user, logout_user, lookup_user_token
from Tourney.utils.security.csrf import generate_nonce
from Tourney.utils.security.email import (
...
def init_template_globals(app):
    from Tourney.constants import JINJA_ENUMS  # noqa: I001
    from Tourney.constants.assets import Assets
    from Tourney.constants.config import Configs
    from Tourney.constants.languages import Languages
    from Tourney.constants.plugins import Plugins
    from Tourney.constants.sessions import Session
    from Tourney.constants.static import Static
    from Tourney.constants.teams import Team
    from Tourney.constants.users import User
    from Tourney.forms import Forms
    ...
    from Tourney.utils.countries import get_countries, lookup_country_code
    from Tourney.utils.countries.geoip import lookup_ip_address, lookup_ip_address_city
...
def init_request_processors(app):
    ...
    @app.before_request
    def csrf():
        # TODO: Tourney 4.0 Consider reorganizing this function to only run on non safe methods
