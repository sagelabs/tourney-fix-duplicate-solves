...
# TODO: Tourney 4.0. Consider changing to a dataclass
UserAttrsFields = [
    "id",
    "oauth_id",
    "name",
...
class _UserAttrsWrapper:
    def __getattr__(self, attr):
        from Tourney.utils.user import get_current_user_attrs
    ...
    @property
    def place(self):
        from Tourney.utils.user import get_user_place

        return get_user_place(user_id=self.id)

    @property
    def score(self):
        from Tourney.utils.user import get_user_score
