...
class Notifications(db.Model):
    ...
    @property
    def html(self):
        from Tourney.utils.config.pages import build_markdown
        from Tourney.utils.helpers import markup
...
class Pages(db.Model):
    ...
    @property
    def html(self):
        from Tourney.utils.config.pages import build_html, build_markdown
...
class Challenges(db.Model):
    ...
    def plugin_class(self):
        from Tourney.plugins.challenges import get_chal_class
...
class Awards(db.Model):
    ...
    @hybrid_property
    def account_id(self):
        from Tourney.utils import get_config
...
class Users(db.Model):
    ...
    def validate_password(self, key, plaintext):
        from Tourney.utils.crypto import hash_password
    ...
    def get_place(self, admin=False, numeric=False):
        """
        This method is generally a clone of Tourney.scoreboard.get_standings.
        The point being that models.py must be self-reliant and have little
        to no imports within the Tourney application as importing from the
        application itself will result in a circular import.
        """
        from Tourney.utils.humanize.numbers import ordinalize
        from Tourney.utils.scores import get_user_standings
...
class Teams(db.Model):
    ...
    def get_invite_code(self):
        ...
        from Tourney.utils.security.signing import hmac, serialize
    ...
    def load_invite_code(cls, code):
        ...
        from Tourney.exceptions import TeamTokenExpiredException, TeamTokenInvalidException
        from Tourney.utils.security.signing import (
            BadSignature,
            BadTimeSignature,
            hmac,
            unserialize,
    ...
    def get_place(self, admin=False, numeric=False):
        ...
        """
        from Tourney.utils.humanize.numbers import ordinalize
        from Tourney.utils.scores import get_team_standings  # noqa: I001
